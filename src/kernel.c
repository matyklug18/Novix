...
void terminal_initialize(void){
    terminal_row = 0;
    terminal_column = 0;
    terminal_color = vga_entry_color(VGA_DARK_GREY, VGA_BLACK);
...
void terminal_setcolor(uint8_t color){
    terminal_color = color; // wow what a kool thing
}
...
void kernel_main(void){
    terminal_initialize();
    // terminal_writestring("This kernel was written by Asoina, Vresod and AVCADO\n");
